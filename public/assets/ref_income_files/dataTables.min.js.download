...
(function(h) {
    ...
    function rb(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            g = '<input type="search" placeholder="Search" class="form-control control3' + b.sFilterInput + '"/>',
            j = d.sSearch,
            ...
            i = h("input", b).val(e.sSearch).attr("placeholder", "Search").on("keyup.DT search.DT input.DT paste.DT cut.DT", g ? Qa(f, g) : f).on("keypress.DT", function(a) {
    ...
    function qb(a) {
        for (var b = a.oClasses, c = a.sTableId, d = a.aLengthMenu, e = h.isArray(d[0]), f = e ? d[0] : d, d = e ? d[1] : d, e = h("<select class='custom_datatable control3'/>", {
                name: c + "_length",
                "aria-controls": c,
